...
names(pop3.all)<-c('agec','borough', '2015','2020')
pop3.all$'2016'<-NA
pop3.all$'2017'<-NA
pop3.all$'2018'<-NA
pop3.all$'2019'<-NA
...
pop3<-apply(pop3.all.c, c(2,3), function(z){
  interpol1<-approx(z, n=6)
  return(interpol1[[2]])
}
  )
names(pop3)<-c('year','borough','agec')
dimnames(pop3)[[1]]<-c(2015:2020)
saveRDS(pop3,'borough.pop.rds')
```
