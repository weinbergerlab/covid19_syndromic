...
# all.pred<- lapply(all.gam.res, function(x){ 
#               lapply(x, function(y) sapply(y,'[[','pred'))
# }
#               )
# all.pred<-array(unlist(all.pred) ,dim=dim(ds1.c))
# 
# par(mfrow=c(5,1), mar=c(3,2,1,1))
# for(i in 1:5){
#   plot(obs[,1,i], type='l', bty='l', ylab='Fitted')
#   points(all.pred[,1,i,1], type='l', col='red' )
# }
