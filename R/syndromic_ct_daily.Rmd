...
glm.func<-function(x.test, age.test, syndrome, all.cause.name){
  ...
  out.list<-list(y=y.age[1,], pred=my_data_with_pi$pred, resid1=resid1, upi=my_data_with_pi$upb, lpi=my_data_with_pi$lpb,'all.cause'= t(clean.array.citywide[,age.test,all.cause.name]))
