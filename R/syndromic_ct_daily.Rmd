...
```{r, eval=F}
ds1.m<-melt(ds2[,c('adate', 'County','agec','ili','cough','respiratory','circulatory','ili2','all.visits', 'ili2.admit', 'resp.admit','admitted')], id.vars=c('adate','County','agec'))
...
par(mfrow=c(2,3))  
for(k in ages){
  plot(ds1.c[k,,i,j]/ds1.c[k,,i,'admitted'], type='l', bty='l', main=paste(j,i,k))
  }
 }
}
